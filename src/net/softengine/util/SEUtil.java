...
public class SEUtil {
    ...
    /*public static String getUniqueFileName2(){
        String filename="";
    ...
    public static List<String> getDocTypeList() {
        return SEConstants.DOC_TYPE_TYPE_LIST;
    }

    public static String getDocType(Integer index) {
        try {
            return SEConstants.DOC_TYPE_TYPE_LIST.get(index);
        } catch (Exception e) {
            return "";
        }
    }
    ...
    public static String getMonth(Integer monthSerial) {
        try {
            return SEConstants.MONTH_LIST.get(monthSerial - 1);
        } catch (Exception e) {
            return "";
        }
    }
